...
class Model(torch.nn.Module):
    ...
    def forward(
        ...
        print(f"Initial input shape: {batch['inputs'].shape}")  # Add this line
        ...
        if self.encoder is not None:
            ...
            print(f"Shape after reshaping: {batch['inputs'].shape}")  # Add this line
        ...
        if prep_batch:
            ...
            print(f"Shape after prep_batch: {batch['inputs'].shape}")  # Add this line
        ...
        print(f"Shape after embedder: {batch['inputs_embeds'].shape}")  # Add this line

        outputs = self.decoder(batch=batch)
        print(f"Shape after decoder: {outputs['outputs'].shape}")  # Add this line
        ...
        if self.unembedder is not None and not self.is_decoding_mode:
            ...
            print(f"Shape after unembedder: {outputs['outputs'].shape}")  # Add this line
